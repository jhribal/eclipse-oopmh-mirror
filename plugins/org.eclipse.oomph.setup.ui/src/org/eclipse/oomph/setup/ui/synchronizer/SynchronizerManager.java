...
public final class SynchronizerManager
{
  ...
  private static ICredentialsProvider configureCredentialProvider()
  {
    try
    {
      ...
      String oauthClientId = PropertiesUtil.getProperty("oomph.oauth.clientId", "@oomph.oauth.clientId@");
      String oauthClientSecret = PropertiesUtil.getProperty("oomph.oauth.clientSecret", "@oomph.oauth.clientSecret@");
