...
public class ProgressPage extends SetupWizardPage
{
  ...
  protected void createCheckButtons(ButtonBar buttonBar)
  {
    ...
    {
      // If oomph.setup.installer.launch is not set create a checkbox for launchAutomatically. Otherwise use the set value
      if (PropertiesUtil.getBoolean(SetupProperties.PROP_SETUP_LAUNCH_AUTOMATICALLY) == null)
      {
      ...
      {
        launchAutomatically = PropertiesUtil.getBoolean(SetupProperties.PROP_SETUP_LAUNCH_AUTOMATICALLY);
      }
    }
