...
public class AgentAnalyzerComposite extends Composite
{
  ...
  private void createBundlePoolViewer()
  {
    ...
    repairAllArtifactsButton.setText(Messages.AgentAnalyzerComposite_repairDamagedArtifacts);
  ...
  private void updateBundlePoolButtons()
  {
    ...
    if (currentBundlePool != null)
    {
      ...
      changed |= updateButton(repairAllArtifactsButton, currentBundlePool.getDamagedArtifactsCount(), Messages.AgentAnalyzerComposite_repairDamagedArtifacts,
          Messages.AgentAnalyzerComposite_repairDamagedArtifacts_withCount);
