...
public class SelfProductCatalogURIHandlerImpl extends URIHandlerImpl
{
  ...
  public InputStream createInputStream(URI uri, Map<?, ?> options) throws IOException
  {
    ...
    {
      throw new IOException(MessageFormat.format(Messages.SelfProductCatalogURIHandlerImpl_NoProductCatalog_exception, uri));
    }
  }
  ...
  {
    throw new IOException(MessageFormat.format(Messages.SelfProductCatalogURIHandlerImpl_CannotWrite_exception, uri));
  }

  @Override
  public void delete(URI uri, Map<?, ?> options) throws IOException
  {
    throw new IOException(MessageFormat.format(Messages.SelfProductCatalogURIHandlerImpl_CannotDelete_exception, uri));
  }
  ...
  {
    throw new IOException(MessageFormat.format(Messages.SelfProductCatalogURIHandlerImpl_CannotSetAttributes_exception, uri));
  }
}
