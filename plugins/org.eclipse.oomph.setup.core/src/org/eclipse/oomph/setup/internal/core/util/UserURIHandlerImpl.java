...
public class UserURIHandlerImpl extends URIHandlerImpl implements URIResolver
{
  ...
  private Resource create(URI uri, URI normalizedURI)
  {
    ...
    if (query != null)
    {
      ...
      if (ePackage == null)
      {
        throw new IllegalArgumentException(MessageFormat.format(Messages.UserURIHandlerImpl_NoPackage_exception, classURI));
      }
      ...
      {
        throw new IllegalArgumentException(MessageFormat.format(Messages.UserURIHandlerImpl_NoClass_exception, classURI));
      }
