...
public abstract class BackendSystem extends BackendContainer
{
  ...
  private BackendResource createMember(Object delegateMember, URI systemRelativeURI, boolean checkExists) throws Exception
  {
    ...
    switch (type)
    {
      ...
      default:
        throw new BackendException(MessageFormat.format(Messages.BackendSystem_InvalidMember_exception, type.toString().toLowerCase(), delegateMember));
    }
  }
  ...
  private static final class VisitorThread extends Thread
  {
    ...
    {
      super(MessageFormat.format(Messages.BackendSystem_Visitor_thread, ++lastID));
      this.pool = pool;
      setDaemon(true);
    }
  ...
  public interface IFactory
  {
    ...
    public static final class Registry
    {
      ...
      private IFactory loadFactory(String scheme) throws BackendException
      {
        ...
        throw new BackendException(MessageFormat.format(Messages.BackendSystem_SchemeNotFound_exception, scheme));
      }
