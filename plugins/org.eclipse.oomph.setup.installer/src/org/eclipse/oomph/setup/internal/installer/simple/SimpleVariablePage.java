...
import org.eclipse.oomph.setup.internal.installer.InstallerUtil;
import org.eclipse.oomph.setup.internal.installer.SetupInstallerPlugin;
import org.eclipse.oomph.setup.internal.installer.simple.InstallLaunchButton.State;
...
public class SimpleVariablePage extends SimpleInstallerPage
{
  ...
  private static final String DEFAULT_INSTALL_ERROR_MESSAGE = "An error occured while installing the items";
  ...
  private OomphButton javaButton;

  private Text folderText;

  private OomphButton folderButton;
  ...
  private OomphButton cancelButton;

  private OomphButton showReadmeButton;

  private OomphButton keepInstallerButton;

  private Composite afterInstallComposite;

  private OomphButton showInstallLogButton;
  ...
  private OomphButton createButton(Composite parent, String text, String toolTip, Image icon)
  {
    OomphButton button = new OomphButton(parent, SWT.PUSH);
      ...
      public void run()
      {
        ...
        catch (Exception ex)
        {
          if (!progress.isCanceled())
          {
            ...
            installError = DEFAULT_INSTALL_ERROR_MESSAGE;
          }
        }
        finally
        {
  ...
  private void showInstallError()
  {
    ...
    dialog.showMessage(errorMessage, Type.ERROR, false, handler);
