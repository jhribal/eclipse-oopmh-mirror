...
import org.eclipse.oomph.setup.internal.installer.simple.MessageOverlay.ActionHandler;
import org.eclipse.oomph.setup.internal.installer.simple.MessageOverlay.Locator;
import org.eclipse.oomph.setup.internal.installer.simple.MessageOverlay.Type;
import org.eclipse.oomph.setup.internal.installer.simple.SimpleInstallerMenu.InstallerMenuItem;
...
public final class SimpleInstallerDialog extends AbstractSimpleDialog implements InstallerUI
{
  ...
  protected void createUI(Composite titleComposite)
  {
    ...
    OomphButton exitButton = new ImageHoverButton(exitMenuButtonContainer, SWT.PUSH, SetupInstallerPlugin.INSTANCE.getSWTImage("simple/exit.png"),
  ...
  private SimpleInstallerMenu createIntallerMenu()
  {
    ...
    updateLauncherItem.setDefaultImage(SetupInstallerPlugin.INSTANCE.getSWTImage("simple/exclamation_circle.png"));
    updateLauncherItem.setHoverImage(SetupInstallerPlugin.INSTANCE.getSWTImage("simple/exclamation_circle_hover.png"));
    updateLauncherItem.setText("UPDATE INSTALLER");
    ...
    bundlePoolingItem.setText("BUNDLE POOL...");
  ...
  public void showMessage(String message, Type type, boolean dismissAutomatically, ActionHandler handler)
  {
    clearMessage();
