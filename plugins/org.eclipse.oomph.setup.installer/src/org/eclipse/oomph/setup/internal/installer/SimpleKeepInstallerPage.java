...
public class SimpleKeepInstallerPage extends SimpleInstallerPage
{
  ...
  private SimpleInstallerButton applyButton;
  ...
  protected void createContent(Composite container)
  {
    ...
    SimpleInstallerButton folderButton = new ImageHoverButton(varContainer, SWT.PUSH, SetupInstallerPlugin.INSTANCE.getSWTImage("simple/folder.png"),
    ...
    applyButton = new SimpleInstallerButton(varContainer, SWT.PUSH);
