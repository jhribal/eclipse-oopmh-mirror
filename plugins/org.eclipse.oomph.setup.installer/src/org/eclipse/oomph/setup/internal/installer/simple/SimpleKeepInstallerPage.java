...
import org.eclipse.oomph.setup.internal.installer.InstallerApplication;
...
public class SimpleKeepInstallerPage extends SimpleInstallerPage
{
  ...
  private OomphButton applyButton;
  ...
  protected void createContent(Composite container)
  {
    ...
    OomphButton folderButton = new ImageHoverButton(varContainer, SWT.PUSH, SetupInstallerPlugin.INSTANCE.getSWTImage("simple/folder.png"),
    ...
    applyButton = new OomphButton(varContainer, SWT.PUSH);
    ...
    applyButton.setForeground(SimpleInstallerDialog.COLOR_WHITE);
