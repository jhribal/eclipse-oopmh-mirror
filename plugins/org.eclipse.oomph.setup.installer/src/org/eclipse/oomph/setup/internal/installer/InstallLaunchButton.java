...
public class InstallLaunchButton extends ImageHoverButton
{
  ...
  private ProgressAnimation progressSpinner;
  ...
  public InstallLaunchButton(Composite parent)
  {
    ...
    {
      progressSpinner = new ProgressAnimation(SetupInstallerPlugin.INSTANCE.getSWTImage("simple/progress_sprite.png"), 8, 4, 20);
  ...
  {
    INSTALL("INSTALL", "Start product installation", COLOR_INSTALL, COLOR_FOREGROUND_DEFAULT, SetupInstallerPlugin.INSTANCE
        .getSWTImage("simple/install_button_install.png"), SetupInstallerPlugin.INSTANCE.getSWTImage("simple/install_button_install_hover.png"),
    ...
    LAUNCH("LAUNCH", "Launch the selected product", COLOR_LAUNCH, COLOR_FOREGROUND_DEFAULT, SetupInstallerPlugin.INSTANCE
        .getSWTImage("simple/install_button_launch.png"), SetupInstallerPlugin.INSTANCE.getSWTImage("simple/install_button_launch_hover.png"), null);
  ...
  /**
   * Simple animation of progress. In contrast to {@link SpriteAnimator}, this animation is
   * not a SWT component eases handling of transparency on different platforms.
   *
   * @author Andreas Scharf
   */
  private class ProgressAnimation implements Runnable
  {
    ...
    public ProgressAnimation(Image textureAtlas, int countX, int countY, long delay)
    {
      this.delay = delay;
