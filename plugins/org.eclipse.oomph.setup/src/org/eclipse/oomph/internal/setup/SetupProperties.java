...
public interface SetupProperties
{
  ...
  /**
   * Automatically accepts unsigned content iff set to true
   */
  ...
  /**
   * 'simple' starts the installer in simple mode, 'advanced' in advanced mode. Property is not case sensitive
   */
  ...
  /**
   * If set the 'launch automatically' and the 'restart if needed' check boxes are disabled and the set value (true or false) will be used instead
   */
  public static final String PROP_SETUP_LAUNCH_AUTOMATICALLY = "oomph.setup.installer.launch";

  /**
   * If set the 'use p2 bundle pool' check box is disabled and the set value (true or false) will be used instead
   */
  public static final String PROP_SETUP_INSTALLER_P2_POOL = "oomph.setup.installer.p2pool";
