...
public class EclipseIniTaskImpl extends SetupTaskImpl implements EclipseIniTask
{
  ...
  public void perform(SetupTaskContext context) throws Exception
  {
    ...
    if (!file.exists())
    {
      context.log(MessageFormat.format(Messages.EclipseIniTaskImpl_Skipping_message, file));
      return;
    }

    if (contents != null || createNewContent(context))
    {
      context.log(MessageFormat.format(Messages.EclipseIniTaskImpl_Changing_message, file, getLabel(getValue())));
      ...
      context.setRestartNeeded(MessageFormat.format(Messages.EclipseIniTaskImpl_FileHasChanged_message, file.getName()));
    }
  }
