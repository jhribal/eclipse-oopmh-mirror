...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>git</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GitExample
{
  ...
  public static void main(String[] args)
  {
    ...
    if (args.length == 0)
    {
      ...
      try
      {
        Resource resource = resourceSet.createResource(URI.createURI("http:///My.git"));
        GitCloneTask root = GitFactory.eINSTANCE.createGitCloneTask();
