...
public interface GitPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Clone All Branches</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int GIT_CLONE_TASK__CLONE_ALL_BRANCHES = SetupPackage.SETUP_TASK_FEATURE_COUNT + 6;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.oomph.setup.git.GitCloneTask#isCloneAllBranches <em>Clone All Branches</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Clone All Branches</em>'.
   * @see org.eclipse.oomph.setup.git.GitCloneTask#isCloneAllBranches()
   * @see #getGitCloneTask()
   * @generated
   */
  EAttribute getGitCloneTask_CloneAllBranches();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Clone All Branches</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute GIT_CLONE_TASK__CLONE_ALL_BRANCHES = eINSTANCE.getGitCloneTask_CloneAllBranches();
