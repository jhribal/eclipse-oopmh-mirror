      ...
      for (IVMInstallType type : types)
      {
        if (vmInstallTypeID.equals(type.getId()))
        {
          ...
          if (!jreLibraries.isEmpty())
          {
            ...
            {
              IPath jreLibraryPath = installPath.append(jreLibrary.getLibraryPath());
              ...
              for (int i = 0; i < libraryLocations.length; i++)
              {
                ...
                {
                  Path externalAnnotationsPath = new Path(jreLibrary.getExternalAnnotationsPath());
                  if (!externalAnnotationsPath.equals(libraryLocation.getExternalAnnotationsPath()))
                  {
                    LibraryLocation newLibraryLocation = new LibraryLocation(libraryLocation.getSystemLibraryPath(),
                        libraryLocation.getSystemLibrarySourcePath(), libraryLocation.getPackageRootPath(), libraryLocation.getJavadocLocation(),
                        libraryLocation.getIndexLocation(), externalAnnotationsPath);
