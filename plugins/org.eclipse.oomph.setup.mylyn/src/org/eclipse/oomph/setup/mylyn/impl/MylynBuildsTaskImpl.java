    ...
    callback.execInUI(false, new Runnable()
    {
      public void run()
      {
        ...
        else
        {
          ...
          context.log(MessageFormat.format(Messages.MylynBuildsTaskImpl_AddingServer_message, connectorKind, serverURL));
        ...
        {
          context.log(MessageFormat.format(Messages.MylynBuildsTaskImpl_AddingBuildPlan_message, connectorKind, buildPlanName));
