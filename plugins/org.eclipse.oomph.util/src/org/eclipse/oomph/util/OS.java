...
public abstract class OS
{
  ...
  private static OS create()
  {
    ...
    throw new IllegalStateException(MessageFormat.format(Messages.OS_OS_NotSupported_exception, os));
  }
  ...
  private static final class Linux extends OS
  {
    ...
    public Process execute(List<String> command, boolean terminal) throws Exception
    {
      if (terminal)
      {
        ...
        throw new IOException(MessageFormat.format(Messages.OS_CannotStartTerminal_exception, new Object[] { TERMINAL_COMMANDS }));
      }
