...
public class APIBaselineFromTargetTaskImpl extends AbstractAPIBaselineTaskImpl implements APIBaselineFromTargetTask
{
  ...
  public void perform(SetupTaskContext context) throws Exception
  {
    if (backupRequired)
    {
      ...
      context.log(MessageFormat.format(Messages.APIBaselineFromTargetTaskImpl_Backup_message, backupName));
    ...
    if (target == null)
    {
      context.log(MessageFormat.format(Messages.APIBaselineFromTargetTaskImpl_CreateEmptyBaseline_message, targetName), Severity.WARNING);
    ...
    if (baseline == null)
    {
      context.log(MessageFormat.format(Messages.APIBaselineFromTargetTaskImpl_CreatingBaseline_message, targetName));
    ...
    {
      context.log(MessageFormat.format(Messages.APIBaselineFromTargetTaskImpl_ActivatingBaseline_message, baselineName));
