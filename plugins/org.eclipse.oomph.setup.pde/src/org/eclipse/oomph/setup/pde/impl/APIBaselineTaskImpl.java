...
public class APIBaselineTaskImpl extends AbstractAPIBaselineTaskImpl implements APIBaselineTask
{
  ...
  public void perform(SetupTaskContext context) throws Exception
  {
    ...
    if (baseline == null)
    {
      ...
      context.log(MessageFormat.format(Messages.APIBaselineTaskImpl_CreatingBaseline_message, location));
    ...
    if (isActivate())
    {
      context.log(MessageFormat.format(Messages.APIBaselineTaskImpl_ActivatingBaseline_message, baselineName));
  ...
  private void downloadAndUnzip(final SetupTaskContext context) throws Exception
  {
    ...
    ZIPUtil.unzip(zipFile, new ZIPUtil.FileSystemUnzipHandler(baselineDir, ZIPUtil.DEFAULT_BUFFER_SIZE)
    {
      ...
      {
        context.log(MessageFormat.format(Messages.APIBaselineTaskImpl_Unzipping_message, name));
